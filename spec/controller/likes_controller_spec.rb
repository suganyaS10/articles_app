...
RSpec.describe LikesController , :type => :controller do
  ...
  describe "POST create" do
    context 'when the article already had likes row' do
      before do
    ...
    context 'when the article already does not have likes row' do
      # before :all do
      #   @like = Like.create_or_find_by(article_id: 100)
      # end
